...
Sounds pretty good all round - super smooth and clean. Because any kind of phase modulation will introduce disconiuties at the window edges, it best to overlap 2 singal windows and also have a window function to zero the edges.
